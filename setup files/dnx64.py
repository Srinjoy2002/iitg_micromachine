...
METHOD_SIGNATURES: dict = {
    ...
    "GetLensFinePosLimits": ([ctypes.c_long, ctypes.POINTER(ctypes.c_long), ctypes.POINTER(ctypes.c_long)], ctypes.c_long),
...
class DNX64:
    ...
    def GetLensFinePosLimits(self, device_index: int) -> Tuple[int,int]:
        ...
        Get the lens fine position limits for the specified device.
    ...
    def SetAimpointLevel(self, device_index: int, apl_level: int) -> None:
        ...
        Set the Aim point laser level for the specified device.
    ...
    def SetLensFinePos(self, device_index: int, lens_fine_position: int) -> None:
        ...
        Set the lens fine position for the specified device.
